      ...
      <div className="bg-blue-200 lg:relative lg:h-screen">
        ...
        <div className="relative w-full h-64 sm:h-72 md:h-96 lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2 lg:h-full">
          <img
            ...
            src="https://images.unsplash.com/photo-1473531761844-5a14668fc8f8?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=763&q=80"
            alt=""
          />
        </div>
      </div>
          ...
          <div className="mt-6 prose prose-blue prose-lg text-gray-500 mx-auto">
            ...
            <figure>
              <img
                ...
                src="https://images.unsplash.com/photo-1581579186913-45ac3e6efe93?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1470&q=80"
                alt=""
                width={1310}
                height={873}
              />

        ...
        <div className="mx-auto max-w-7xl w-full pt-16 pb-20 text-center lg:py-48 lg:text-left">
          <div className="px-4 lg:w-1/2 sm:px-8 xl:pr-16">
            <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl lg:text-5xl xl:text-6xl">
              ...
              <span className="block text-blue-600 xl:inline">too short.</span>
            </h1>
            <p className="mt-3 max-w-md mx-auto text-lg text-gray-500 sm:text-xl md:mt-5 md:max-w-3xl">
              Ensuring that you are financially secure to face any type of
              problem in life is what matters most.
            </p>
            ...
            <div id="contact" className="grid grid-cols-1 lg:grid-cols-3">
              ...
              <div className="relative overflow-hidden py-10 px-6 bg-blue-700 sm:px-10 xl:p-12">
                ...
                <p className="mt-6 text-base text-blue-50 max-w-3xl">
                  Have any question&apos;s or concerns? Do not hesitate to reach
                  out to and someone will respond as soon as possible.
                </p>
